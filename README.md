...
Codebase for the MRLNK framework, a JavaScript framework written in TypeScript, designed for use in Webflow projects and possibly React apps. This repository provides tools and scripts to help streamline the development, testing, and deployment of the project.
...
This repository supports the MRLNK framework by handling code formatting, linting, testing, and deployment for Webflow-based websites and possibly React apps. With integrated CI/CD, it automates code quality checks and version releases, making it easy to maintain and update.
...
NPM_TOKEN: To automatically deploy package updates to npm, set an NPM_TOKEN in the repository’s GitHub secrets.
